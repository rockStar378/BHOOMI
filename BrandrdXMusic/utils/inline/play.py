...
def stream_markup_timer(_, vidid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text="🥂  ᴀᴅᴅ ᴍᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🥂", url=f"https://t.me/https://t.me/kavya_music_robot?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users")],
...
[
            InlineKeyboardButton(
                text="🥀 ᴏᴡɴᴇʀ 🥀", url=f"https://t.me/chiiilll_vibes"
            ),
            InlineKeyboardButton(
                text="🥀 ᴄʜᴀᴛ 🥀", url=f"https://t.me/+kcUYpG4mFaU5NDE1"
            ),
        ],
